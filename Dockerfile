...
ARG BASE_IMAGE=registry.gitlab.int.fam-feser.de/iac-environment/iac-platform-assets/ansible-ci-image:latest@sha256:4264c200b109a268fb4b210f48c010c461c9dc68eab2be244a8d9245b7cec637
FROM ${BASE_IMAGE}
